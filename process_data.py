...
writer = pd.ExcelWriter('df_ytd_week.xlsx')
df_ytd_week.to_excel(writer,'Sheet1')
writer.save()
#汇总.to_csv(export_path+'total.csv', encoding=encoding, sep=',', index=False)
writer1 = pd.ExcelWriter('total.xlsx')
汇总.to_excel(writer1,'Sheet1')
writer1.save()
#个人业绩YTD.to_csv(export_path+'sales_figures.csv', encoding=encoding, index=False)
writer2 = pd.ExcelWriter('sales_figures.xlsx')
个人业绩YTD.to_excel(writer2,'Sheet1')
writer2.save()
#业绩排名表.to_csv(export_path+'sales_ranking.csv',encoding=encoding,index=False)
writer3 = pd.ExcelWriter('sales_ranking.xlsx')
业绩排名表.to_excel(writer3,'Sheet1')
writer3.save()
#sales_by_team.to_csv(export_path+'sales_by_team.csv',encoding=encoding,index=False)
writer4 = pd.ExcelWriter('sales_by_team.xlsx')
sales_by_team.to_excel(writer4,'Sheet1')
writer4.save()